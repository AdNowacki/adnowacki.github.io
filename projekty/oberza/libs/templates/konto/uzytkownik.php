    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <section class="contact">
                <h2 class='section-title'><span><strong>NOWE KONTO</strong></span></h2>
                        ...
                        <div class="form-wrap">
                            <!-- nowe konto -->
                                <form action="<?= BASE . $this->controller_name . '/' . $this->action_name . '/' . $this->param; ?>" class='form new-account' method='post'>
                                    ...
                                    <p>Już tylko jeden krok dzieli Cie od aktywacji konta. Stwórz bezpieczne hasło. Hasło nie może być krótsze niż 6 znaków i nie może zawierać spacji. Za jego pomocą będziesz mógł sie odtąd zalogować do Strefy Marki Iveco.</p>
                                    <table>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                                <button name='new-account-send' value='1'>ZMIEŃ</button>
                                            </td>
                                        </tr>
                                    </table>
                                </form>
