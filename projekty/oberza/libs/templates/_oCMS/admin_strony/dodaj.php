...
<div class="content admin-content">
	<div class="ctn1360">
		<h1>Dodaj nowe wydarzenia</strong></h1>
		<div class="row">
			<div class="wctn row">
				<div class="col-sm-8">
					<form method="post" class="uedit uadd form-ocms" enctype="multipart/form-data">
	                    ...
	                    <div class="form-field form-field-checkbox">
	                        <label for="menu">
	                        	<?php $checked = ( $this->data['menu_'] == 1 ) ? 'checked' : '';  ?>
	                        	<input type="checkbox" name='menu' id='menu' value='1' <?= $checked; ?>> Zaznacz aby dodac do górnego menu
	                        </label>
	                    </div>

						<br><br>
	                    <div><a href="<?= BASE; ?>admin_strony/widok" class="page-action-link"><i class="icon-wroc"></i> Wróć do listy stron</a> <button name="add" class="or-btn or-link" value="1">Zapisz</button></div>
	                </form>
                </div>
