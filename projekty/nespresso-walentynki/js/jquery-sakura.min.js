...
(function ($) {
    ...
    $.fn.sakura = function (options) {
        ...
        var petalCreator = function () {
            _p++;
            _tp++;
            var tr = ( _tp%7 == 0 || _tp%6 == 0 || _tp%13 == 0 ) ? 'classTransform' : '';
            if( _p == 5 ) {
                _p = 1;
            }
            var _class = 'p'+_p;

            var zIndexRand = Math.ceil( ( Math.random() * 10 ) );
            var zindex = ( zIndexRand%2 == 0 ) ? 'zindex100000' : 'zindex955';
            var sakura = $('<div class="' + options.className + ' ' + _class + ' ' + tr + ' '+zindex+'" />');
            sakura.addClass(_class);
            setTimeout(function () {
            ...
            var fallTime = (Math.round(1600 * 0.007) + Math.random() * 5) * options.fallSpeed;
            ...
            var animations = 'fall ' + fallTime + 's linear 0s 1' + ', ' +
                ...
                swayAnimation + ' ' + getRandomInt(2, 4) + 's ease 0s infinite';
