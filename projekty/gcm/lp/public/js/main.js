...
$("[data-time-format]").each(function(){
    var date = $(this).attr("data-time-format");
    $(this).countdown(date, function(event) {
        $(this).html(event.strftime('<div class="x-time__item">%D<span class="x-time__txt">Dni</span></div><span class="x-spacer">:</span><div class="x-time__item">%H<span class="x-time__txt">Godzin</span></div><span class="x-spacer">:</span><div class="x-time__item">%M<span class="x-time__txt">Minut</span></div><span class="x-spacer">:</span><div class="x-time__item">%S<span class="x-time__txt">Sekund</span></div>'));
    });
});
