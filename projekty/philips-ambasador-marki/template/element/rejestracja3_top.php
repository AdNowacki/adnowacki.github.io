        <div id="top">
            <div id="top_fix">
                ...
                <div id="user">
                    ...
                    <div id="u_img"><img src="images/user-img-def.jpg" alt='Małgorzata' /></div>
                    <div id="u_det">
                    ...
                    <span class="gill_sansMT">Masz 0 punktów</span>
                </div>
                <!-- użytkownik end -->
                ...
                <!-- Box blog -->
                <div id="blog_box" class="reg gill_sans">
                    <span><a href="">AMBASADORZY <br /> PHILIPSA</a></span>
                </div>
                <div id="blog_box2" class="reg non_marg gill_sans">
                    <span><a href="">BLOG<br />RODZINY PHILIPSA</a></span>
                </div>
                <!-- Box blog end -->
